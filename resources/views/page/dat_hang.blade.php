							...
							<div class="your-order-body">
								<ul	class="payment_methods methods">
									<li class="payment_method_bacs">
										<input id="payment_method_bacs" type="radio" class="input-radio" name="delivery_method"  value="VTP20000" checked="checked" data-order_button_text="">
										<label for="payment_method_bacs">Giao hàng Viettel Post 20.000 VND </label>
																
									</li>
									<li class="payment_method_bacs">
										<input id="payment_method_bacs" type="radio" class="input-radio" name="delivery_method"  value="J&T23000"  data-order_button_text="">
										<label for="payment_method_bacs">Giao hàng J&T 23.000 VND </label>
																
									</li>
									<li class="payment_method_bacs">
										<input id="payment_method_bacs" type="radio" class="input-radio" name="delivery_method"  value="GHTK18000"  data-order_button_text="">
